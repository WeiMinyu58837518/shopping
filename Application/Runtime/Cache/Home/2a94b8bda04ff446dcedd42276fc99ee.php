          ...
          <div class="category-content" id="guide_2">
            ...
            <div class="category">
              <ul class="category-list" id="js_climit_li">
                <?php if(is_array($cate)): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$first): $mod = ($i % 2 );++$i; if( $first["pid"] == 0 ): ?><li class="appliance js_toggle relative">
                      <div class="category-info">
                        <h3 class="category-name b-category-name">
                          <i><img src="/Public/Home/images/cookies.png"></i><a class="ml-22" title="<?php echo ($first["cate_id"]); ?>"><?php echo ($first["cate_name"]); ?></a>
                        </h3>
                        <em>&gt;</em></div>
                      <div class="menu-item menu-in top">
                        <div class="area-in">
                          <div class="area-bg">
                            <div class="menu-srot">
                              <div class="sort-side">
                                <?php if(is_array($cate)): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$second): $mod = ($i % 2 );++$i; if( $second["pid"] == $first["cate_id"] ): ?><dl class="dl-sort">
                                      <dt><span title="<?php echo ($second["cate_id"]); ?>"><?php echo ($second["cate_name"]); ?></span></dt>
                                      <?php if(is_array($cate)): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$last): $mod = ($i % 2 );++$i; if( $last["pid"] == $second["cate_id"] ): ?><dd><a title="<?php echo ($last["cate_id"]); ?>" href="#"><span><?php echo ($last["cate_name"]); ?></span></a>
                              ...
                              <div class="brand-side">
                                <dl class="dl-sort">
                                  ...
                                  <dd><a rel="nofollow" title="索比诺官方旗舰店" target="_blank" href="#" rel="nofollow"><span>索比诺官方旗舰店</span></a>
                                  </dd>
                                  <dd>
                                    <a rel="nofollow" title="onTTno傲徒" target="_blank" href="#" rel="nofollow"><span class="red">onTTno傲徒</span></a>
                                  </dd>
                                  <dd><a rel="nofollow" title="玛狮路男装旗舰店" target="_blank" href="#" rel="nofollow"><span>玛狮路男装旗舰店</span></a>
                                  </dd>
                                  <dd><a rel="nofollow" title="劳威特品牌男装" target="_blank" href="#" rel="nofollow"><span>劳威特品牌男装</span></a>
                                  </dd>
                                  <dd>
      ...
      <div class="am-g am-g-fixed flood method3 ">
        <ul class="am-thumbnails ">
          <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li>
            <div class="list ">
              <a href="/Home/Index/detail/id/<?php echo ($v["id"]); ?>.html">
                <img src="<?php echo ($v["goods_big_img"]); ?>"/>
